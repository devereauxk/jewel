...
TEMPLATE=korinna/ZJet_pp8160v3.dat
NJOBS=500
PARALLEL=5
...
for (( c=1; c<=NJOBS; c++ )); do
    sed "s/xxxx/$c/g" "$TEMPLATE" > "parameters/ZJet_pp8160v3_$c.dat"
    ./jewel-2.4.0-vac "parameters/ZJet_pp8160v3_$c.dat" &
    count=$((count + 1))
...
OUTROOT="/raid5/data/kdevero/jewel_workspace/validation/jewel_pp8160v3_MOD_500k.root"

"$CONVERTDIR/ConvertHepMCToRoot" eventfiles/out_ZJet_pp8160v3_*.hepmc "$OUTROOT"
